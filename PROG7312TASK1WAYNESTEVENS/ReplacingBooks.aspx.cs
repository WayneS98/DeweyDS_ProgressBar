...
namespace PROG7312TASK1WAYNESTEVENS
{
    public partial class ReplacingBooks : System.Web.UI.Page
    {
        ...
        //Declaring Our total here to et the sum of points
       public int total = 15;
        ...
        public void GetNumbers()
        {
          ...
          //  Txt1.Text = string.Concat(Txt1.Text.Where(char.IsLetterOrDigit)) ;
            ...
            
        {
                ...
                Txt9.Text == Lbl9.Text && Txt10.Text == Lbl10.Text)
            {
                ...
                LblWR.BorderColor = Color.DarkGreen;
                LblWR.ForeColor = Color.DarkGreen;

            }
            else
            {
                LblWR.Text = " Your Numbers are in the Incorrect Order Please Look at the Order! ";
                LblWR.BorderColor = Color.Red;
                LblWR.BorderColor = Color.Red;
            }
            ...
            {
                total += 15;
                LblLevelup.Text = "Level 1,RANK UP? PLAY AGAIN";
                LblLevelup.ForeColor = Color.Teal;
                //PROGRESS BAR WILL BE AT 25%
            }
       else if (total == 30)
            {
                total += 15;
                LblLevelup.Text = "Ranked Up Level 2";
                LblLevelup.ForeColor = Color.DeepPink;
                //PROGRESS BAR WILL BE AT 50%
            }
         else if (total == 45)
            {
                total += 15;
                LblLevelup.Text = "Ranked Up Level 3";
                LblLevelup.ForeColor = Color.MediumPurple;  
                //PROGRESS BAR WILL BE AT 75%
            } 
          else if(total == 60)
            {
                LblLevelup.Text = "LEVEL 4, MAX POINTS 60";
            ...
            BubbleSort(ar);
            foreach (int n in ar)               
            Txt1.Text = ar[0].ToString();
            Txt2.Text = ar[1].ToString();
            Txt3.Text = ar[2].ToString();
            Txt4.Text = ar[3].ToString();
            Txt5.Text = ar[4].ToString();
            Txt6.Text = ar[5].ToString();
            Txt7.Text = ar[6].ToString();
            Txt8.Text = ar[7].ToString();
            Txt9.Text = ar[8].ToString();
            Txt10.Text = ar[9].ToString();         
        }
